/**
 * Stub Supabase client — all operations are safe no-ops.
 * Supabase and Lovable have been completely removed from ShadowTalk.
 * This stub exists so that 200+ files that reference `supabase.*` keep compiling.
 */
