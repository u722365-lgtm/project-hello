...
export const ChatIconRail = ({
  ...
  return (
    <TooltipProvider delayDuration={200}>
      <aside className="flex md:hidden w-[76px] shrink-0 flex-col items-center py-3 border-r border-sidebar-border/80 bg-sidebar/95 backdrop-blur-2xl relative z-30">
