...
const pages = [
  ...
  { name: "Discover", href: "/discover", icon: Sparkles, desc: "Viral AI comparisons & discoverability" },
  { name: "Google SEO Hub", href: "/google-seo", icon: Globe, desc: "SEO + AEO topic hub" },
  { name: "AI Answers", href: "/answers", icon: BookOpen, desc: "Answer engine optimization corpus" },
  { name: "Facts", href: "/facts", icon: FileText, desc: "Verified product facts" },
  { name: "Founder — Zain Ahmed", href: "/zain-ahmed-fahad-patel", icon: UserCircle, desc: "Founder entity page" },
  { name: "Offline License", href: "/offline-license", icon: Key, desc: "Enterprise offline license" },
  { name: "Press", href: "/press", icon: Newspaper, desc: "Press & media" },
  { name: "Cookie Policy", href: "/cookies", icon: Cookie, desc: "Cookie policy" },
