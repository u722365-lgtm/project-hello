...
export const DOC_FEATURES: DocFeatureItem[] = [
  ...
  {
    icon: "users",
    title: "Autonomous Mode (Twin)",
    description: "Launch a background autonomous twin to help you execute goals proactively.",
    badge: "Premium+",
  },
  {
    icon: "search",
    title: "Deep Research (Omniscience)",
    description: "Multi-step planetary-scale research and analysis.",
    badge: "Core",
  },
  {
    icon: "zap",
...
export const DOC_PRICING_TIERS: DocPricingTier[] = [
  {
    ...
    highlights: [
      ...
      "Visual Reasoning & Image Decoder",
      "3 file uploads/day · 5 code generations/day · 5 web searches/day",
      "Marketplace, memory, basic models",
