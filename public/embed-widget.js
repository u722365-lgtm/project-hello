(function () {
  ...
  var href = ORIGIN + "/chatbot?utm_source=embed&utm_medium=widget&utm_campaign=product_led";
  var el = document.createElement("a");
  el.href = href;
  el.target = "_blank";
  el.rel = "noopener noreferrer";
  el.setAttribute("data-shadowtalk-widget", "1");
  ...
  el.innerHTML = '<span style="color:#38bdf8">⚡</span> Try <strong style="color:#fff">ShadowTalk AI</strong>';
